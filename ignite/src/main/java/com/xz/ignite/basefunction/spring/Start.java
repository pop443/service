package com.xz.ignite.basefunction.spring;

import com.xz.ignite.basefunction.spring.entity.cust.Spring1Entity;
import com.xz.ignite.basefunction.spring.entity.cust.Spring2EntityCacheConfig;
import com.xz.ignite.basefunction.spring.repository.Spring1EntityRepo;
...
public class Start {
    ...
    private static void baseApi() {
        Spring1Entity spring1Entity = springEntityRepo.findOne(12);
