 ...
 */
public class CallableDemo1 implements IgniteCallable<String>{
    private String cacheName ;
    private UUID uuid ;

    public CallableDemo1(String cacheName, UUID uuid) {
    ...
    public String call() throws Exception {
        ...
        sb.append((String)binaryObjectBuilder.getField("col1"))
                ...
                .append((String)binaryObjectBuilder.getField("col3"))
