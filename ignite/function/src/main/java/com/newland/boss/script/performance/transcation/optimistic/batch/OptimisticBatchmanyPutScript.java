package com.newland.boss.script.performance.transcation.optimistic.batch;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class OptimisticBatchmanyPutScript {
    ...
    public OptimisticBatchmanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                OptimisticBatchmanyPutScriptWork work = new OptimisticBatchmanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        OptimisticBatchmanyPutScript scirpt = new OptimisticBatchmanyPutScript(enterParam);
        scirpt.start();
    }
