package com.newland.boss.script.performance.randomw.partitionmanyput.lock.one;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class LockEPOnemanyPutScript {
    ...
    public LockEPOnemanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                LockOnemanyPutScriptWork work = new LockOnemanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        LockEPOnemanyPutScript scirpt = new LockEPOnemanyPutScript(enterParam);
        scirpt.start();
    }
