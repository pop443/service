package com.newland.boss.script.performance.transcation.optimistic.one.repeatableread;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class OptimisticEPOnemanyPutScript {
    ...
    public OptimisticEPOnemanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                OptimisticEPOnemanyPutScriptWork work = new OptimisticEPOnemanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        OptimisticEPOnemanyPutScript scirpt = new OptimisticEPOnemanyPutScript(enterParam);
        scirpt.start();
    }
