...
import com.newland.boss.entity.performance.bulk.TextObjConfiguration;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class TextPutScript {
    private Ignite ignite;
    private IgniteCache<String, TextObj> igniteCache ;
    private EnterParam enterParam;

    public TextPutScript(EnterParam enterParam) {
        ignite = IgniteUtil.getIgnite();
        this.enterParam = enterParam;
        TextObjConfiguration cfg = new TextObjConfiguration();
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                TextPutScriptWork work = new TextPutScriptWork(enterParam, igniteCache,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        TextPutScript scirpt = new TextPutScript(enterParam);
        scirpt.start();
    }
