 ...
 */
public class OptimisticBatchmanyPutScriptWork implements Callable<Long> {
    ...
    public OptimisticBatchmanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,TranscationCache1> igniteCache1, IgniteCache<String,TranscationCache2> igniteCache2, Integer baseKey) {
