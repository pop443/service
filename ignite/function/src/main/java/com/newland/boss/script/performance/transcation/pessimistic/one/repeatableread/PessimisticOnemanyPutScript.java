 ...
 * 随机写性能测试 1K 多表多次put
 */
public class PessimisticOnemanyPutScript {
    ...
    public PessimisticOnemanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PessimisticOnemanyPutScriptWork work = new PessimisticOnemanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PessimisticOnemanyPutScript scirpt = new PessimisticOnemanyPutScript(enterParam);
        scirpt.start();
    }
