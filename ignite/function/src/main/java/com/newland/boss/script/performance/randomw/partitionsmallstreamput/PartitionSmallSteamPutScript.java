...
public class PartitionSmallSteamPutScript extends BaseScript<String,PartitionSmallCustObj> {
    ...
    public PartitionSmallSteamPutScript(int count, int threadNum) {
    ...
    public void work() {
        ...
        for (int i = 0; i < threadNum; i++) {
            PartitionSmallSteamPutScriptWork work = new PartitionSmallSteamPutScriptWork(eachSize,count,getIgniteDataStreamer()) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("流式导入分区小对象数据量："+count+";线程："+threadNum);
        PartitionSmallSteamPutScript scirpt = new PartitionSmallSteamPutScript(count,threadNum) ;
        scirpt.start();
    }
