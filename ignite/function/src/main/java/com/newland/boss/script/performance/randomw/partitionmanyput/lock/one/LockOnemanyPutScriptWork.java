...
public class LockOnemanyPutScriptWork implements Callable<Long> {
    ...
    public LockOnemanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,PartitionCustObj> igniteCache1, IgniteCache<String,PartitionCustObj2> igniteCache2, Integer baseKey) {
    ...
    private Long working() {
        ...
        for (int i = 0; i < list1.size(); i++) {
            PartitionCustObj cache1 = list1.get(i) ;
            PartitionCustObj2 cache2 = list2.get(i) ;
