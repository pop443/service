 ...
 */
public class InnerEpAff implements EntryProcessor<BinaryObject,BinaryObject,Boolean> {

    @IgniteInstanceResource
    private Ignite ignite;
    private IgniteCache<String,BinaryObject> cache2 ;

    public InnerEpAff(IgniteCache<String, BinaryObject> cache2) {
        this.cache2 = cache2;
    }

    @Override
    public Boolean process(MutableEntry<BinaryObject, BinaryObject> mutableEntry, Object... objects) throws EntryProcessorException {
        Boolean bo = false ;
        try {
