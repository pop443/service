 ...
 * 随机写性能测试 1K 多表多次put
 */
public class PessimisticmanyEpPutScript {
    ...
    public PessimisticmanyEpPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PessimisticmanyEpPutScriptWork work = new PessimisticmanyEpPutScriptWork(enterParam, ignite,list,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PessimisticmanyEpPutScript scirpt = new PessimisticmanyEpPutScript(enterParam);
        scirpt.start();
    }
