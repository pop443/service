 ...
 */
public class PessimisticOnemanyPutScriptWork implements Callable<Long> {
    ...
    public PessimisticOnemanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,TranscationCache1> igniteCache1, IgniteCache<String,TranscationCache2> igniteCache2, Integer baseKey) {
