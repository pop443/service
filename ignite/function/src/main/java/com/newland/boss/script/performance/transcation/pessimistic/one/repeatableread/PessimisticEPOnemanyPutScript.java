package com.newland.boss.script.performance.transcation.pessimistic.one.repeatableread;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class PessimisticEPOnemanyPutScript {
    ...
    public PessimisticEPOnemanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PessimisticEPOnemanyPutScriptWork work = new PessimisticEPOnemanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PessimisticEPOnemanyPutScript scirpt = new PessimisticEPOnemanyPutScript(enterParam);
        scirpt.start();
    }
