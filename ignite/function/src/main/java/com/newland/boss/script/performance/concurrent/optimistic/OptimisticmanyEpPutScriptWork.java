 ...
 */
public class OptimisticmanyEpPutScriptWork implements Callable<Long> {
    ...
    public OptimisticmanyEpPutScriptWork(EnterParam enterParam, Ignite ignite, List<IgniteCache> list , Integer baseKey) {
