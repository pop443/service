...
public class PartitionSmallEpPutScript extends BaseScript<String,PartitionSmallCustObj> {
    ...
    public PartitionSmallEpPutScript(EnterParam enterParam) {
    ...
    public void work() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            PartitionSmallEpPutScriptWork work = new PartitionSmallEpPutScriptWork(enterParam,igniteCache) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("导入分区缓存小对象数据量："+enterParam.toString());
        PartitionSmallEpPutScript scirpt = new PartitionSmallEpPutScript(enterParam) ;
        scirpt.start();
    }
}