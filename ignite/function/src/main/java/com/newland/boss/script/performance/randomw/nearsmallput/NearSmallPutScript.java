...
public class NearSmallPutScript extends BaseScript<String,NearSmallCustObj> {
    ...
    public NearSmallPutScript(int count, int threadNum) {
    ...
    public void work() {
        ...
        for (int i = 0; i < threadNum; i++) {
            NearSmallPutScriptWork work = new NearSmallPutScriptWork(eachSize,count,igniteCache) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("导入近缓存分区小对象数据量："+count+";线程："+threadNum);
        NearSmallPutScript scirpt = new NearSmallPutScript(count,threadNum) ;
        scirpt.start();
    }
