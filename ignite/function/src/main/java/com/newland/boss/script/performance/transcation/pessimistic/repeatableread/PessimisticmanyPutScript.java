 ...
 * 随机写性能测试 1K 多表多次put
 */
public class PessimisticmanyPutScript {
    ...
    public PessimisticmanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PessimisticmanyPutScriptWork work = new PessimisticmanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PessimisticmanyPutScript scirpt = new PessimisticmanyPutScript(enterParam);
        scirpt.start();
    }
