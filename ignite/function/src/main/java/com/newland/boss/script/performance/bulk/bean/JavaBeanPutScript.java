 ...
 * 随机写性能测试 1K 多表多次put
 */
public class JavaBeanPutScript {
    private Ignite ignite;
    private IgniteCache<String, JavaObj> igniteCache ;
    private EnterParam enterParam;

    public JavaBeanPutScript(EnterParam enterParam) {
        ignite = IgniteUtil.getIgnite();
        this.enterParam = enterParam;
        JavaObjConfiguration cfg = new JavaObjConfiguration();
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                JavaBeanPutScriptWork work = new JavaBeanPutScriptWork(enterParam, igniteCache,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("java bean Put ：" + enterParam.toString());
        JavaBeanPutScript scirpt = new JavaBeanPutScript(enterParam);
        scirpt.start();
    }
