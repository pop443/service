 ...
 * 随机写性能测试 1K 多表多次put
 */
public class JsonPutScript {
    private Ignite ignite;
    private IgniteCache<String, String> igniteCache ;
    private EnterParam enterParam;

    public JsonPutScript(EnterParam enterParam) {
        ignite = IgniteUtil.getIgnite();
        this.enterParam = enterParam;
        JsonObjConfiguration cfg = new JsonObjConfiguration();
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                JsonPutScriptWork work = new JsonPutScriptWork(enterParam, igniteCache,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        JsonPutScript scirpt = new JsonPutScript(enterParam);
        scirpt.start();
    }
