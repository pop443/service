package com.newland.boss.script.performance.transcation.optimistic.repeatableread;
 ...
 */
public class OptimisticEPmanyPutScriptWork implements Callable<Long> {
    ...
    public OptimisticEPmanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,TranscationCache1> igniteCache1, IgniteCache<String,TranscationCache2> igniteCache2, Integer baseKey) {
