...
public class PartitionSmallPutScript extends BaseScript<String,PartitionSmallCustObj> {
    ...
    public PartitionSmallPutScript(EnterParam enterParam) {
    ...
    public void work() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            PartitionSmallPutScriptWork work = new PartitionSmallPutScriptWork(enterParam,igniteCache) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        PartitionSmallPutScript scirpt = new PartitionSmallPutScript(enterParam) ;
        scirpt.start();
    }
}
