 ...
 * 随机写性能测试 1K 多表多次put
 */
public class PessimisticBatchmanyPutScript {
    ...
    public PessimisticBatchmanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PessimisticBatchmanyPutScriptWork work = new PessimisticBatchmanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        PessimisticBatchmanyPutScript scirpt = new PessimisticBatchmanyPutScript(enterParam);
        scirpt.start();
    }
