package com.newland.boss.script.performance.randomr.partitionsmallEPput;
 ...
 */
public class PartitionSmallEpPutScript extends BaseScript<String,PartitionSmallCustObj> {
    private int count ;
    private int threadNum ;
    private ExecutorService executorService ;
    public PartitionSmallEpPutScript(int count, int threadNum) {
    ...
    public void work() {
        ...
        for (int i = 0; i < threadNum; i++) {
            PartitionSmallEpPutScriptWork work = new PartitionSmallEpPutScriptWork(eachSize,count,igniteCache) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("读分区小对象数据量："+count+";线程："+threadNum);
        PartitionSmallEpPutScript scirpt = new PartitionSmallEpPutScript(count,threadNum) ;
        scirpt.start();
    }
