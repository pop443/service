 ...
 */
public class PartitionManyPutGetScriptWork implements Callable<Long> {
    ...
    public PartitionManyPutGetScriptWork(EnterParam enterParam, IgniteCache<String,PartitionCustObj> igniteCache1, IgniteCache<String,PartitionCustObj2> igniteCache2, Integer baseKey) {
    ...
    private Long working() {
        ...
        for (int i = 0; i < list1.size(); i++) {
            ...
            igniteCache1.get(list1.get(i).getId()+"-1") ;
            igniteCache1.get(list1.get(i).getId()+"-2") ;
            igniteCache2.get(list2.get(i).getId()+"-1") ;
            igniteCache2.get(list2.get(i).getId()+"-2") ;
        }
