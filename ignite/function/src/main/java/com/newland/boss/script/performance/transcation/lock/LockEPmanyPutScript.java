package com.newland.boss.script.performance.transcation.lock;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class LockEPmanyPutScript {
    ...
    public LockEPmanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                LockEPmanyPutScriptWork work = new LockEPmanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        LockEPmanyPutScript scirpt = new LockEPmanyPutScript(enterParam);
        scirpt.start();
    }
