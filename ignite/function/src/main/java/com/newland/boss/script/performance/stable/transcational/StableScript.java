...
public class StableScript {
    ...
    public StableScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                StableScriptWork work = new StableScriptWork(enterParam, ignite,list,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        StableScript scirpt = new StableScript(enterParam);
        scirpt.start();
    }
