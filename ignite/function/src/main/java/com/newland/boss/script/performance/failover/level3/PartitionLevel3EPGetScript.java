 ...
 */
public class PartitionLevel3EPGetScript extends PerformanceScript<String,PartitionLevel2> {
    PartitionLevel3EPGetScript(EnterParam enterParam, Class<? extends PerformanceScriptWork<String, PartitionLevel2>> cz) {
