...
public class PartitionBigSteamPutScript extends BaseScript<String,PartitionBigCustObj> {
    ...
    public PartitionBigSteamPutScript(EnterParam enterParam) {
    ...
    public void work() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            PartitionBigSteamPutScriptWork work = new PartitionBigSteamPutScriptWork(enterParam,getIgniteDataStreamer()) ;
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("流式导入分区缓存大对象数据量："+enterParam.toString());
        PartitionBigSteamPutScript scirpt = new PartitionBigSteamPutScript(enterParam) ;
        scirpt.start();
    }
}
