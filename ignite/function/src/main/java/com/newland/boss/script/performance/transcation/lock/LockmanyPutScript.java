 ...
 * 随机写性能测试 1K 多表多次put
 */
public class LockmanyPutScript {
    ...
    public LockmanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                LockmanyPutScriptWork work = new LockmanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        LockmanyPutScript scirpt = new LockmanyPutScript(enterParam);
        scirpt.start();
    }
