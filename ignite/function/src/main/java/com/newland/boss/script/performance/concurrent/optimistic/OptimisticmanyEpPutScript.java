package com.newland.boss.script.performance.concurrent.optimistic;
 ...
 * 随机写性能测试 1K 多表多次put
 */
public class OptimisticmanyEpPutScript {
    ...
    public OptimisticmanyEpPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                OptimisticmanyEpPutScriptWork work = new OptimisticmanyEpPutScriptWork(enterParam, ignite,list,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        OptimisticmanyEpPutScript scirpt = new OptimisticmanyEpPutScript(enterParam);
        scirpt.start();
    }
