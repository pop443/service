 ...
 */
public class OptimisticmanyPutScriptWork implements Callable<Long> {
    ...
    public OptimisticmanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,TranscationCache1> igniteCache1, IgniteCache<String,TranscationCache2> igniteCache2, Integer baseKey) {
