 ...
 */
public class LockmanyPutScriptWork implements Callable<Long> {
    ...
    public LockmanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,PartitionCustObj> igniteCache1, IgniteCache<String,PartitionCustObj2> igniteCache2, Integer baseKey) {
