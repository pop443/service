 ...
 * 随机写性能测试 1K 多表多次put
 */
public class OptimisticOnemanyPutScript {
    ...
    public OptimisticOnemanyPutScript(EnterParam enterParam) {
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                OptimisticOnemanyPutScriptWork work = new OptimisticOnemanyPutScriptWork(enterParam, ignite,igniteCache1, igniteCache2,baseKey);
    ...
    public static void main(String[] args) throws Exception {
        ...
        OptimisticOnemanyPutScript scirpt = new OptimisticOnemanyPutScript(enterParam);
        scirpt.start();
    }
