...
public class PartitionManyPGScript_3 {
    ...
    private PartitionCustObjConfiguration bigcfg = new PartitionCustObjConfiguration(2);
    ...
    public void start() {
        ...
        for (int u = 0; u < enterParam.getLoop(); u++) {
            ...
            for (int i = 0; i < enterParam.getThreadNum(); i++) {
                ...
                PartitionManyPutScriptWork work1 = new PartitionManyPutScriptWork(enterParam, igniteCache1, igniteCache2,baseKey);
