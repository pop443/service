...
public class RangeCalcIndexScriptWork extends PerformanceScriptWork<String, AffinityItemNo> {
    ...
    public RangeCalcIndexScriptWork(EnterParam enterParam, IgniteCache<String, AffinityItemNo> igniteCache, IgniteDataStreamer<String, AffinityItemNo> igniteDataStreamer,Integer baseKey) {
    ...
    private void query(List<String> list){
        ...
        sbSQL.append("select * from NEWLAND.AFFINITYITEMNO t where 1=1 and t.range2 in (") ;
