...
public class LockEPOnemanyPutScriptWork implements Callable<Long> {
    ...
    public LockEPOnemanyPutScriptWork(EnterParam enterParam, Ignite ignite, IgniteCache<String,PartitionCustObj> igniteCache1, IgniteCache<String,PartitionCustObj2> igniteCache2, Integer baseKey) {
