package com.newland.ignite.query.oracle;
...
public class OracleConnection extends ConnectionUtil {
    ...
    private static Properties properties = PropertiesConfig.getProperties("oracle.properties");
    ...
    public static void main(String[] args) throws SQLException{
        Connection conn = OracleConnection.getDruidDataSource().getConnection() ;
        PreparedStatement pstm = conn.prepareStatement("select 1,2 from dual");
